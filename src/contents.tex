...
\cventry{\faIcon{redhat}\hfill present}
    {\emph{Preparing the} Red Hat Certified Specialist in Enterprise Application Server Administration \emph{exam}}
    {EX248}
    {}
    {}
    {Acquired \textbf{AD248} experience from working within the operations team of an important inter-bank transaction service, within SIA/Nexi Ltd.}
...
\cvcomputer{\textbf{DevOps}}{Git, Mercurial, Ansible, OpenShift, Kubernetes, JBoss EAP, Consul, Nomad.}
